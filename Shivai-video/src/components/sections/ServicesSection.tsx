...
import { Camera, Heart, Building2, PartyPopper, Sparkles } from "lucide-react";
...
const services = [
  ...
  },
  {
    id: 2,
    title: "Pre-Wedding",
    description: "Romantic outdoor & destination pre-wedding shoots",
    icon: Camera,
  ...
  },
  {
    ...
    description: "Mehndi, Haldi, Sangeet & cultural ceremonies",
    icon: Sparkles,
    image: haldiCeremony,
  },
];
              ...
              <div className="relative h-80 overflow-hidden">
                ...
                <motion.div
                  ...
                  animate={{
                    ...
                    scale: hoveredId === service.id ? 1 : 0.9,
                  }}
